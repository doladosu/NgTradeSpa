angular.module('app.controllers', [])
	...
	.controller('SmartAppController', ['$scope', 'userService', function ($scope, userService) {
		  ...
		  $scope.items = [
			 {
				title: 'Msgs',
				count: 14,
				src: 'content/account/ajax/notify/mail.html',
			 ...
			 },
			 {
				title: 'Notify',
				count: 3,
				src: 'content/account/ajax/notify/notifications.html'
			 },
			 {
				title: 'Tasks',
				count: 4,
				src: 'content/account/ajax/notify/tasks.html',
				//active: true
			 }
		  ];
